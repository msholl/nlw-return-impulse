...
return (
    <>
        ...
        <div className="flex flex-col items-center py-10 w-[304px]">
            ...
            <span className="text-xl m-8">
                Agradecos o feedback!
            </span>

            <button
                type="button"
                onClick={onFeedbackRestartRequested}
            className="py-2 px-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors focus:outline-none focus:outline-brand-500 focus:right-2 focus:ring-offset-2 focus:ring-offset-zinc-900 disabled:opacity-50 disabled:hover:bg-brand-500"
            >
                Quero enviar outro
            </button>
        </div>
